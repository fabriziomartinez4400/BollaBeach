...
function _CharsetSetToHtml( &$html, $charset, $xhtml = false )
{
	...
	$html = substr( $html, 0, $htmlHeadBegin ) . '<meta charset="' . strtoupper( $charset ) . '"><meta http-equiv="Content-Type" content="text/html;charset=' . strtoupper( $charset ) . '"' . ( $xhtml ? ' /' : '' ) . '>' . substr( $html, $htmlHeadBegin );
}
